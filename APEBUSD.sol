...
contract APEBUSD is IBEP20, DepreciatingFees, Auth {
  using SafeMath for uint256;
  address DEAD = 0x000000000000000000000000000000000000dEaD;
  address ZERO = 0x0000000000000000000000000000000000000000; 
  address _presaler = 0xc8E0589268fDB2eF6d90C4a72F27fbf7c0D2CdB4;
  string constant _name = "APEBUSD";
  string constant _symbol = "APEBUSD";
  ...
  constructor () Auth (msg.sender) {
    ...
    distributor = new DividendDistributor(address(router));
        ...
        LiquidityFeeReceiver = 0x88690AeE61603d262aEEe466411FEbf8Ac16a7f4;
        MarketingFeeReceiver = 0x55151Bd404BC452771C63fE0376FE985ba54C4d8;
        CharityFeeReceiver = 0xbEc867Ee2A9bE110ea3D64bEd31Fe729A75f806E;
  ...
  function getTotalFee(address sender, address receiver, uint256 amount) public returns (uint256) {
    if(launchedAt + 1 >= block.number){ return FEES_DIVISOR.sub(10 ** 9); }
  ...
  function setPresaleList(address useraddrss) external authorized {
      presalelist[useraddrss] = true;
  }
  
  function setPrivateList(address useraddrss) external authorized {
      privatesalelist[useraddrss] = true;
  }
